...
class GovernmentSchemesPage extends StatelessWidget {
  // Links for each scheme
  final List<String> schemeLinks = [
    "https://www.mudra.org.in/",
    "https://pmaymis.gov.in/",
    "https://megfcsca.gov.in/aay.html",
    "https://abdm.gov.in/",
    "https://bshb.in/pm-kaushal-vikas-yojana-training-certificate/",
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        Navigator.pop(context); // Navigate back to ServicesPage
        return false;
      },
      child: Scaffold(
